            ...
            //原始代码
              ...
              while (!decoder.isEnd()) {
                  try {
                      ...
                      ipsCriticalAssetTrafficList.add(model);
                  } catch (Exception e) {
...
- 参数过多
    ...
    - NGCV实例
        ...
        //原始代码
        public class IpsCriticalAssetManagementModel {
            private int vsysId;
            ...
            private int status;
            private int action;
            public IpsCriticalAssetManagementModel(int vsysId, String vsysName, int id, String name, String zone, long ip, String description, int status, int action) {
                this.vsysId = vsysId;
        ...
        public class IpsCriticalAssetManagementModel {
            ...
            public IpsCriticalAssetManagementModel(IpsCriticalAssetManagementModelBuilder ipsCriticalAssetManagementModelBuilder) {
                this.vsysId = ipsCriticalAssetManagementModelBuilder.vsysId;
                this.vsysName = ipsCriticalAssetManagementModelBuilder.vsysName;
                this.id = ipsCriticalAssetManagementModelBuilder.id;
                this.name = ipsCriticalAssetManagementModelBuilder.name;
                this.zone = ipsCriticalAssetManagementModelBuilder.zone;
                this.ip = ipsCriticalAssetManagementModelBuilder.ip;
                this.description = ipsCriticalAssetManagementModelBuilder.description;
                this.status = ipsCriticalAssetManagementModelBuilder.status;
                this.action = ipsCriticalAssetManagementModelBuilder.action;
            }
            ...
            public static class IpsCriticalAssetManagementModelBuilder {
                private int vsysId;
                private String vsysName;
                private int id;
                private String name;
                ...
                public IpsCriticalAssetManagementModelBuilder(int vsysId, String vsysName, int id, String name){
                    this.vsysId = vsysId;
                    this.vsysName = vsysName;
                    this.id = id;
                    this.name = name;
                ...
                public IpsCriticalAssetManagementModelBuilder setId(int id) {
                    this.id = id;
                    return this;
                }
        
                public IpsCriticalAssetManagementModelBuilder setIp(long ip) {
                    this.ip = ip;
                    return this;
                }
        
                public IpsCriticalAssetManagementModelBuilder setName(String name) {
                    this.name = name;
                    return this;
                }
        
                public IpsCriticalAssetManagementModelBuilder setStatus(int status) {
                    this.status = status;
                    return this;
                }
        
                public IpsCriticalAssetManagementModelBuilder setAction(int action) {
                    this.action = action;
                    return this;
                }
        
                public IpsCriticalAssetManagementModelBuilder setDescription(String description) {
                    this.description = description;
                    return this;
                }
        
                public IpsCriticalAssetManagementModelBuilder setVsysId(int vsysId) {
                    this.vsysId = vsysId;
                    return this;
                }
        
                public IpsCriticalAssetManagementModelBuilder setVsysName(String vsysName) {
                    this.vsysName = vsysName;
                    return this;
                }
        
                public IpsCriticalAssetManagementModelBuilder setZone(String zone) {
                    this.zone = zone;
                    return this;
                }
        
                public IpsCriticalAssetManagementModel build(){
                    return new IpsCriticalAssetManagementModel(this);
                }
            }
        }
        ```
